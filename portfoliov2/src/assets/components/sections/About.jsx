...
export const About = ({ image, onImageChange1, onImageChange2, currentData, onFinishLoading }) => {
    const settings = {
        dots: true,
        infinite: true,
        speed: 500,
...
/>
        <div className="aboutContainer">
            ...
            <h3 className="titleFont center white">quests&nbsp; 
                ...
                <h4 className='center'>→ view my <a href='https://docs.google.com/document/d/1-k0W10jzwevb6pspTTL6hp3bLAj1jgDwr_VGr0AC_G4/edit?usp=sharing' target="_blank" className='white'>resume</a></h4>
            </div>
        ...
        <h3 className="titleFont center white white">skills&nbsp;
            ...
            <div className="fourSkills">
                ...
                <div className="devToolsContainer">
                    <h4 className="titleFont">dev tools</h4>
